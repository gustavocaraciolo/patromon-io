...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, io.patrimon.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, io.patrimon.repository.UserRepository.USERS_BY_EMAIL_CACHE);
